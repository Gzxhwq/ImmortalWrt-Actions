...
sed -i 's/--all-servers --cache --cache-min-ttl=3600/--fastest-addr --cache --cache-min-ttl=600/g' ./feeds/luci/applications/luci-app-turboacc/root/etc/init.d/turboacc